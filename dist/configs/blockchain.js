...
exports.getChainConfig = exports.MainnetConfigs = exports.TestnetConfigs = exports.BlockchainNetwork = void 0;
...
const getChainConfig = (chain) => {
    if (process.env.DEPLOY_MAINNET === 'true') {
        return exports.MainnetConfigs[chain];
    }
    return exports.TestnetConfigs[chain];
};
