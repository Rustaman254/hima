 ...
 */
export async function createPrivyWallet(phone) {
    try {
 ...
 */
export async function createPolkadotWallet() {
 ...
 */
export async function createSmartWallet(walletId, evmAddress) {
    try {
 ...
 */
export async function deployWalletOnEVM(walletId, to, caip2, chainId) {
